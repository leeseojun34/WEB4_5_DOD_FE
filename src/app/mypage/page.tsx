...
const mypage = () => {
  ...
  return (
    <div className="w-full flex flex-col py-11">
      <div className="flex flex-1 flex-col justify-between gap-27">
        ...
        <div className="flex justify-between items-center text-xs mx-23">
          <span className="font-light text-[var(--color-gray-placeholder)] hover:text-[var(--color-primary-400)] cursor-pointer">
            계정탈퇴
          </span>
          <span className="font-normal text-[var(--color-gray-placeholder)] hover:text-[var(--color-primary-400)] cursor-pointer">
            로그아웃
          </span>
        </div>
      </div>
      ...
      {sheetType === "time" && (
        <BottomSheet isOpen={isOpen} setIsOpen={setIsOpen} snapPoints={800}>
          <div className="w-full flex flex-col px-5 gap-8">
            <div className="flex justify-between items-center px-5">
              <X className="invisible" />
